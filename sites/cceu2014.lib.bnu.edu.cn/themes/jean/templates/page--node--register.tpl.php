...
-->
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" role="main" class="clearfix">
    <?php 
      $breadcrumb_array = array('<a href="/">' . t('Homepage') . '</a>','<a href="/node/1/register">' . t('Register') . '</a>',t('Register'),);
     if (!empty($breadcrumb)) {
         $breadcrumb = '<h2 class="element-invisible">' . t('You are here').'</h2>';
         $breadcrumb .= '<div class="breadcrumb">' . implode(' › ', $breadcrumb_array ) . '</div>';
     }
